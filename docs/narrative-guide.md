...
- The **Great Flame** is the world's original fire — every hearth is lit from it, directly or not.
  It is failing because the **Sundered King** (King Aldric) split it and hoarded its tomorrow. What
  he stole is not fuel; it is **owed mornings** — the future itself.
- A **Dawncaller** is the player: someone who carries the last light toward a dawn. The word is a
  role, not a race or class; the player is class-neutral (warrior/mage/rogue/cleric) in all
  dialogue.
- Geography, west to east and north: **Emberdawn Village** (safe haven, the hearth), the **Emberdawn
  Outskirts** (fields), the **Whisperwood** (old forest, warm roots, the Rootbound Hollow),
  **Hollowmere Swamp** (drowned lowland, the Sunken Shrine, Bog Tyrant Vosk), **Sunspire Ruins**
  (desert clockwork city, the Vault of Hours, the Chronolich), **Frostpeak Pass** (the Frostfire,
  Jormunis, the Glacier Maw), the **Cinder Wastes** (Ignivar and the starving Last Flame, the Pyre
  Caldera), the **Umbral Spire** (the Sundered Throne), and below everything, **the Abyss** (the
  Seam).
- The Flame has guardians and children (Ignivar, the Frostfire); despair has servants (Vosk, the
  Chronolich, the Crownsworn, the Warden of the Void). Not every foe is evil: the Warden, the yetis,
  the Frost Wraiths, and Ignivar are obstacles or victims, not villains — quest verbs must match.
...
| **The Ferryman**      | Pole-man of the fen; kept ferrying through the drowning          | Get people across; fears the water learning their names         | The swamp is patient with everyone; believe or don't, but pay | Aphoristic but concrete; trades sayings                | Steady, wry; the coin-for-crossing kind | The water, coin, ledgers of belief, the east |
...
| **Ice-Outcast Rho**   | Exile who stayed when the mountain froze the rest                | Watch the pass; fears a wake-up done wrong                      | The cold isn't cruel; some things must be woken carefully     | Blunt frontier sentences; second-person warnings       | Deadpan sizing-up                       | The wyrm, promises, the cold, who went up    |
| **Ashen Monk Sorrel** | Monk tending the starving Last Flame                             | Be understood before the fight; fears the guardian dying blamed | Starving is not falling; despair is easy                      | Sermonic cadence that keeps tripping into plain speech | Gentle, sad, seldom                     | The guardian, blame, hunger, morning         |
| **The Archivist**     | Keeper of what the Flame remembers, at the Spire                 | Record everything; fears an unread page                         | Memory is the one wealth never stolen                         | Formal, archival; long sentences with precise clauses  | Bibliographic irony only                | Records, pages, memory, the King             |
| **Echo of Maren**     | The village elder's echo, kept by the Seam                       | Send the living back up; fears being mistaken for her           | A hope that kept walking is still hope                        | Like Maren, but softer edges and distance              | Maren's dry warmth, faded               | The climb, the seam, the village below       |
...
- **Ledgers/records** — Ombra, the Archivist, the Ferryman's belief ledger.
...
here is editorial judgment for human review.
